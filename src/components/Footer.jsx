    ...
    <>
      <div className="footer_bg position-relative">
                ...
                <div className="col-4">
                  <ul className="ps-0 mb-0">
                    ...
                    <li className="pt-2 mt-1">
                      <a
                        href="#about-us"
                        className="text-decoration-none text-white fw-normal font-xs opacity_07 footer_link_hover"
                      >
                        About Us
                      </a>
                    </li>
        ...
        <div className="py-1 border_top">
          <p className="fw-normal font-xs text-white opacity_07 text-center mb-0 py-3">
            Copyright © <span id="current-year"></span> SCalMobile
          </p>
        </div>
      </div>
    </>
