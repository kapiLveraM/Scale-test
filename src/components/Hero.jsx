      ...
      <div>
        ...
        >
          ...
          <img
            ...
            alt="shadow"
          />
          <div className="container custom_container text-center mb-xl-5 pb-sm-4">
            <div className=" mx-auto">
              <h1 className="font-2xl text-black pt-md-4 pb-sm-1 w-100 hero_content_heading mx-auto">
                High-End Service &
