...
const ScalMobile = () => {
  return (
    <>
      <div
        id="partners"
        class="mt-xl-5 mt-md-5 mt-sm-5  mt-4 pt-xl-1"
      >
        <div class="container about_custom_container">
          ...
          text-xl-start mx-auto"
            >
              ...
              <h2 class="font-lg fw_medium custom_light_black mb-0 custom_heading_lh opacity_07 ">
                Doing Things The SCal Mobile Way
              </h2>
              <div>
                <p class="font-sm fw-normal custom_light_black mb-0 pt-md-3 pt-2 mt-sm-1 mt-md-0  custom_lh opacity_07">
                ...
                <p class="font-sm fw-normal custom_light_black mb-0 pt-2 custom_lh opacity_07">
